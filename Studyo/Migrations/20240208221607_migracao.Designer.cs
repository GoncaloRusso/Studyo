...
namespace Studyo.Migrations
{
    ...
    [Migration("20240208221607_migracao")]
            ...
            modelBuilder.Entity("Studyo.Models.Material", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 18,
                            ChapterId = 9,
                            Conteudo = "Antropologia Cultural é um campo da antropologia que se dedica ao estudo das culturas humanas em sua diversidade e complexidade. Ela investiga as crenças, valores, práticas sociais e sistemas simbólicos que moldam as diferentes sociedades ao redor do mundo. Através da imersão em contextos culturais específicos, os antropólogos culturais buscam compreender as perspectivas dos membros de uma comunidade, suas tradições, rituais e formas de organização social. Este campo reconhece a importância da relatividade cultural, entendendo que não existe uma única forma \"correta\" de ser humano, mas sim uma multiplicidade de maneiras de viver e interpretar o mundo. A Antropologia Cultural oferece insights valiosos sobre como as culturas evoluem, interagem e se adaptam ao longo do tempo, promovendo assim a compreensão intercultural e a apreciação da diversidade humana.",
                            QuizId = 18
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 196,
                            ChapterId = 99,
                            Conteudo = "Uma conversação básica pode começar com cumprimentos e perguntas simples para estabelecer conexão e iniciar uma interação significativa. Aqui está um exemplo de uma conversa básica em português:\r\n\r\nPessoa A: Olá!\r\nPessoa B: Olá! Como vai?\r\nPessoa A: Estou bem, obrigado. E você?\r\nPessoa B: Também estou bem, obrigado por perguntar.\r\nPessoa A: Qual é o seu nome?\r\nPessoa B: Meu nome é João. E o seu?\r\nPessoa A: Meu nome é Maria. Prazer em conhecê-lo, João.\r\nPessoa B: Igualmente, Maria.\r\n\r\nA partir daqui, a conversa pode se ramificar para diferentes tópicos, como hobbies, interesses, planos para o dia, ou experiências recentes. O importante é manter o diálogo amigável e aberto, permitindo que ambas as partes compartilhem suas ideias e experiências de forma confortável.",
                            QuizId = 196
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = 224,
                            ChapterId = 113,
                            Conteudo = "O vocabulário latino avançado inclui uma variedade de palavras e expressões que são mais complexas e menos comuns, frequentemente encontradas em textos literários, científicos, filosóficos e jurídicos. Aqui estão algumas categorias de vocabulário latino avançado e exemplos de palavras:\r\n\r\n1. *Vocabulário literário*:\r\n   - poesis (poesia)\r\n   - tragedia (tragédia)\r\n   - comedia (comédia)\r\n   - epistula (carta)\r\n   - fabula (fábula)\r\n   - oratio (discurso)\r\n\r\n2. *Vocabulário filosófico*:\r\n   - philosophia (filosofia)\r\n   - metaphysica (metafísica)\r\n   - ethica (ética)\r\n   - logica (lógica)\r\n   - ontologia (ontologia)\r\n   - epistemologia (epistemologia)\r\n\r\n3. *Vocabulário científico*:\r\n   - scientia (ciência)\r\n   - physica (física)\r\n   - biologia (biologia)\r\n   - chemia (química)\r\n   - astronomia (astronomia)\r\n   - medicina (medicina)\r\n\r\n4. *Vocabulário jurídico*:\r\n   - ius (lei)\r\n   - lex (lei)\r\n   - iudex (juiz)\r\n   - testamento (testamento)\r\n   - testamentum (testamento)\r\n   - crimen (crime)\r\n\r\n5. *Vocabulário religioso*:\r\n   - deus (deus)\r\n   - religio (religião)\r\n   - ecclesia (igreja)\r\n   - fides (fé)\r\n   - divinus (divino)\r\n   - sanctus (santo)\r\n\r\n6. *Vocabulário acadêmico*:\r\n   - academia (academia)\r\n   - schola (escola)\r\n   - discipulus (aluno)\r\n   - magister (mestre)\r\n   - cursus (curso)\r\n   - examen (exame)\r\n\r\n7. *Vocabulário artístico*:\r\n   - ars (arte)\r\n   - musica (música)\r\n   - pictura (pintura)\r\n   - sculptura (escultura)\r\n   - theatra (teatro)\r\n   - poeta (poeta)\r\n\r\n8. *Vocabulário geográfico*:\r\n   - terra (terra)\r\n   - mundus (mundo)\r\n   - regio (região)\r\n   - provincia (província)\r\n   - civitas (cidade)\r\n   - flumen (rio)\r\n\r\nEssas são apenas algumas das muitas palavras encontradas no vocabulário latino avançado. Dominar esse tipo de vocabulário pode ser útil para quem estuda textos latinos mais complexos e especializados, bem como para compreender melhor a cultura e o contexto histórico da Roma Antiga.",
                            QuizId = 224
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Studyo.Models.Material", b =>
                {
                    b.HasOne("Studyo.Models.Chapter", "Chapter")
                        .WithOne("Normal")
                        .HasForeignKey("Studyo.Models.Material", "ChapterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
